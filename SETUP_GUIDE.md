...
```bash
ralphblaster init --token=fm6ibAG6vamdjtbG5snuD3F4 --api-url=https://hq.ralphblaster.com
```
...
```bash
export RALPHBLASTER_API_TOKEN="fm6ibAG6vamdjtbG5snuD3F4"
...
```json
{
  "apiToken": "fm6ibAG6vamdjtbG5snuD3F4",
