...
describe('Executor - Error Categorization', () => {
  ...
  describe('categorizeError()', () => {
    test('categorizes ENOENT as claude_not_installed', () => {
      ...
      const result = executor.categorizeError(error, '', null);
    ...
    test('categorizes authentication failures', () => {
      ...
      const result = executor.categorizeError(error, stderr, 1);
    ...
    test('categorizes non-zero exit code as execution_error', () => {
      ...
      const result = executor.categorizeError(error, stderr, 127);
    ...
    test('includes technical details in all errors', () => {
      ...
      const result = executor.categorizeError(error, stderr, exitCode);
    ...
    test('logs debug message with category', () => {
      ...
      executor.categorizeError(error, '', null);
